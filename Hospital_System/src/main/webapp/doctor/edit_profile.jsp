		...
		<div class="row">
			...
			<div class="col-md-6 offset-md-2">
				<div class="card paint-card">
					...
					<c:if test="${not empty successMsgg }">
						<p class="text-center text-success fs-6">${successMsgg}</p>
						<c:remove var="successMsgg" scope="session" />
					</c:if>

					<c:if test="${not empty errorMsgg }">
						<p class="text-center text-danger fs-6">${errorMsgg}</p>
						<c:remove var="errorMsgg" scope="session" />
					</c:if>
					<div class="card-body">
						<form action="../doctorUpdateProfile" method="post">
							...
							<button type="submit"
								class="btn btn-primary col-md-12 text-center">Update</button>
						</form>
